import pygame
from settings import vertical_size , screen_width , tilt_size
...
class Sky:
    def __init__(self,horizon,style = 'level'):
        ...
        self.top = pygame.transform.scale(self.top,(screen_width,tilt_size))
        self.bottom = pygame.transform.scale(self.bottom,(screen_width,tilt_size))
        self.middle = pygame.transform.scale(self.middle,(screen_width,tilt_size))
        ...
        if self.style == 'overworld':
            ...
            for surface in [choice(palm_surfaces) for image in range(10)]:
                ...
                y= (self.horizon*tilt_size) + randint(50,100)
            ...
            for surface in [choice(cloud_surfaces) for image in range(10)]:
                x= randint(0,screen_width)
                y= randint(0,(self.horizon*tilt_size) - 100)
                rect = surface.get_rect(midbottom = (x,y))
